...
MonsterCardDeck<T>::MonsterCardDeck() {
    ...
    if(file.is_open()) {
        ...
        throw FileOpenningExecption("couldn't open monster_cards file!!!\n"); 
    }
}
    ...
    if(file.is_open()) {
        ...
        while(getline(file, line)) {
            ...
            for (int i {}; i < ITEM_COUNT; i++) {
                ...
                temp.name = name;
                temp.place = place;
                if (color == "red") temp.color = cardColor::Color::RED;
                if (color == "blue") temp.color = cardColor::Color::BLUE;
                if (color == "yellow") temp.color = cardColor::Color::YELLOW;
                this->push(temp);
            }
        }
        file.close();
        ...
        throw FileOpenningExecption("couldn't open items file!!!\n"); 
    }
}
...
PerkDeck<T>::PerkDeck() {
    ...
    if(file.is_open()) {
        ...
        throw FileOpenningExecption("couldn't open perk file!!!\n"); 
    }
}
